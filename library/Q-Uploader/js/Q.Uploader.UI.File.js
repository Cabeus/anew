...
(function (window, undefined) {
    ...
    Uploader.UI.File = {
        ...
        draw: function (task) {
            ...
            var html =
                '<div class="fl">' +
                	'<div class="u-name" title="' + name + '"><div style="float: left;"><span class="glyphicon glyphicon-file" style="font-size:18px;"></span></div><span>' + name + '</span></div>' +
                '</div>' +
                '<div class="fr">' +
                    '<div class="u-size" style="display:none;"></div>' +
                    '<div class="u-speed"  style="display:none;">--/s</div>' +
                    '<div class="u-progress-bar"  style="display:none;">' +
                        '<div class="u-progress" style="width:1%;display:none;"></div>' +
                    '</div>' +
                    '<div class="u-detail" style="display:none;">0%</div>' +
                    '<div class="u-state" style="display:none;"></div>' +
                    '<div class="u-op">' +
                          '<a class="u-op-cancel" style="display:none;">' + text_button_cancel + '</a>' +
